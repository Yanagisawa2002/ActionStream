...
| R009 | M3 | Optional third model | SmolVLA | task 0 then tasks 0-2 | paired primary metrics | NICE | RUNNING | Policy cached; public frozen VLM dependency is downloading before sync/RTC smoke |
| R010 | M4 | Native Isaac install/preflight | Isaac 6.0.1 + ROS Jazzy | remote RTX 5090 | compatibility/build/GPU receipt | MUST | RUNNING | Exact workspace/Pixi verified; first frozen install attempt preserved a prefix.dev tunnel-reset receipt and will resume |
