...
Training is complete. The server remains available. The test split has not been
evaluated, and runtime acceptance has not been enabled. Fresh failed rollouts,
camera interventions, and closed-loop acceptance remain open; validation on
successful demonstration trajectories cannot establish those results.
