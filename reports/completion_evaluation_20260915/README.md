...
The RTX 5090 VLA smoke passed with raw shape `(1,30,20)` and converted action shape `(30,7)`. Three final episode results are pending model materialization at this snapshot.
