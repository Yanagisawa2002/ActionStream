...
from actionstream.action_queue import (
    get_action_with_revision as queue_get_action_with_revision,
    is_action_current as queue_is_action_current,
    merge_chunk as queue_merge_chunk,
    validate_chunk as queue_validate_chunk,
)
from actionstream.delivery_scheduler import (
    delivery_loop as run_delivery_loop,
    notify_delivery_observer as delivery_notify_observer,
    schedule_delivery as delivery_schedule,
)
...
class ActionStreamInferenceEngine(InferenceEngine):
    ...
    def get_action_with_revision(
        ...
        """Pop/hold an action with provenance under the existing queue boundary."""
        return queue_get_action_with_revision(self, obs_frame)
    ...
    def is_action_current(self, action: ActionStreamAction) -> bool:
        ...
        return queue_is_action_current(self, action)
    ...
    def _validate_chunk(chunk: torch.Tensor) -> torch.Tensor:
        return queue_validate_chunk(chunk)
